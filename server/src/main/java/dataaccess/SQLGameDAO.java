...
public class SQLGameDAO implements GameDAO {
    ...
    // Constructor to establish the connection and initialize Gson
    public SQLGameDAO(Connection connection) {
        this.connection = connection;
        this.gson = new Gson();  // Initialize Gson for serialization/deserialization
    }

    @Override
    public void clear() throws DataAccessException {
        String sql = "DELETE FROM games";  // Assuming the table is named 'games'
    ...
    private String serializeGame(ChessGame game) {
        return gson.toJson(game);  // Use Gson to serialize the ChessGame object to a JSON string
    }

    // Method to deserialize JSON to ChessGame
    private ChessGame deserializeGame(String gameDataJson) {
        return gson.fromJson(gameDataJson, ChessGame.class);  // Use Gson to deserialize the JSON string to a ChessGame object
    }
}
